...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 24 20:25:52 2020

@author: david
"""

## Adapted with only small changes from Stanford course CS231n
...
def build_architecture():
    ...
    architecture = [
        ...
        ('ReLU',()),
        ####
        ('Affine', (int(channel_8*imW*imH/(4*4*4)), 48)),
        ('Batchnorm1D', (48)),
        ('ReLU',()),
        ('Dropout',(0.25)),
        ('Affine', (48,6))
...
# Provided by Stanford course CS231n
class Solver(object):
    """
    ...
    def train(self):
        ...
        # At the end of training: run model on test set
        test_acc = self.check_accuracy(self.X_test, self.y_test,
                    num_samples=self.num_test_samples)
        print('Best model for dev. set: train acc: %f; val_acc: %f; test_acc: %f' % (
